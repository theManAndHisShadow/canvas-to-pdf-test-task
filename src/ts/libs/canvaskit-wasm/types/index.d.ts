...
export interface CanvasKit {
    ...
    /**
     * Converts SkPicture to PDF.
     * Important Node: Extra function for patched version of 'canvaskit-wasm'. 
     * For more see: LINK.
     * @param record - SkPicture recording object
     * @param width - PDF page width
     * @param height - PDF page height
     * @returns Uint8Array representing the PDF file
     */
    ConvertToPDF(record: SkPicture, width: number, height: number): Uint8Array;
...
export interface Canvas extends EmbindObject<"Canvas"> {
    ...
    /**
     * Gets the dimensions of the current canvas and returns an object with { width, height }
     * @returns An object containing the width and height of the canvas.
     */
    getSizes(): CanvasSizes;
